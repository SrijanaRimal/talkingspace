            ...
            <div class="col-md-10">
                <div class="topic-content pull-right">
                    ...
                    <div class="topic-info">
                        ...
                        >> <a href="profile.html"><?php echo $topic->username; ?></a> >>
                        <a
                            href="topics.php?user= <?php echo urlFormat($topic->user_id); ?>"><?php echo formateDate($topic->create_date); ?></a>

                        <span class="badge pull-right"><?php echo replyCount($topic->id);
                                                                ?></span>
                    </div>
                </div>
            </div>
...
</ul><?php include('includes/footer.php'); ?>